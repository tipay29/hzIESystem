        ...
        <table class="table pl_table_number" >
            ...
            @if($packinglists[0]['pl_type'] == "APPAREL")
                ...
                <tr>
                    ...
                    <td scope="col"></td>
                    <td scope="col"></td>
                    <td align="right" scope="col"> <b> {{number_format((float)$packinglists[count($packinglists)-1]['total_qty_ship'])}} </b></td>
                    <td align="right" scope="col"> <b> {{number_format((float)$packinglists[count($packinglists)-1]['total_carton'])}} </b> </td>
                    <td align="right" scope="col"> <b> {{number_format((float)$packinglists[count($packinglists)-1]['total_nw'], 2, '.', ',')}} </b></td>
                    <td align="right" scope="col"> <b> {{number_format((float)$packinglists[count($packinglists)-1]['total_gw'], 2, '.', ',')}} </b> </td>
                    <td align="right" scope="col"> <b> {{number_format((float)$packinglists[count($packinglists)-1]['total_cbm'], 2, '.', ',')}} </b> </td>
                </tr>
