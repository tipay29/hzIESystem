...
//            dump($number_number_collection);
            ...
            for($y=0 ; $y < $number_number_count; $y++){
                ...
                }elseif($number_number_collection[$y]->pl_version == 6){
                    $style_code = ltrim(substr($number_number_collection[$y]->pl_sku,-5))
                        . $packinglistArray[$x][$y_Ctrl]['pl_buy_year'] . $packinglistArray[$x][$y_Ctrl]['pl_buy_month']
                        . explode(' ',trim($packinglistArray[$x][$y_Ctrl]['pl_country']))[0];
                }
